...
// Here we start the module unit

module;					// this is global module fragment
...
export module ThaStack;
//export module BCForth;
...
//import "Forth.h";
//import "BaseDefinitions.h";



/*export*/ namespace BCForth
{
	...
	export template < typename T, auto MaxElems, auto kArrayLimit = 64 >
	class TStackFor
	{
	public:
	...
	export template < typename T, auto MaxElems >
